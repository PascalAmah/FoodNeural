          ...
          {teamMembers.map((member, index) => (
            ...
            >
              <div className="mb-4 relative group">
                <div className="relative w-32 h-32 mx-auto mb-4 rounded-full overflow-hidden ring-4 ring-green-500/20 transition-all duration-300 group-hover:ring-green-500/40">
                  <img
                    src={member.avatar}
                    alt={member.name}
